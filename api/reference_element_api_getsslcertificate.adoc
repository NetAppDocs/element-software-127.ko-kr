...
summary: GetSSLCertificate 메서드를 사용하여 클러스터의 스토리지 노드에서 현재 활성 상태인 SSL 인증서를 검색할 수 있습니다. 
---
...
[role="lead"]
메소드를 사용하여 클러스터의 스토리지 노드에서 현재 활성 상태인 SSL 인증서를 검색할 수 `GetSSLCertificate` 있습니다.
