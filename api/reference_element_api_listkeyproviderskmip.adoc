...
[role="lead"]
메소드를 사용하여 기존의 모든 KMIP(Key Management Interoperability Protocol) 키 공급자의 목록을 검색할 수 `ListKeyProvidersKmip` 있습니다. 추가 매개 변수를 지정하여 목록을 필터링할 수 있습니다.
...
KMIP 키 공급자 목록이 생성되었습니다.
 a| 
link:reference_element_api_keyproviderkmip.html["키ProviderKmip 을 참조하십시오"] 선정되었습니다
