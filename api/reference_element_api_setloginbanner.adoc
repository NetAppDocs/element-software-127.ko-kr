...
[role="lead"]
메소드를 사용하여 사용자가 Element 웹 인터페이스에 로그인할 때 표시되는 사용 약관 배너를 구성할 수 `SetLoginBanner` 있습니다.
...
* `true`사용 약관 배너는 웹 인터페이스 로그인 시 표시됩니다.
* `false`사용 약관 배너는 웹 인터페이스 로그인 시 표시되지 않습니다.
