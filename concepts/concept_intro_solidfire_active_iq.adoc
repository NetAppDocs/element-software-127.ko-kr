...
[role="lead"]
https://activeiq.solidfire.com["SolidFire Active IQ"^] 는 클러스터 전체 데이터에 대한 기록 뷰를 지속적으로 업데이트하는 웹 기반 툴입니다. 특정 이벤트, 임계값 또는 메트릭에 대한 알림을 설정할 수 있습니다. SolidFire Active IQ를 사용하면 시스템 성능과 용량을 모니터링할 수 있을 뿐만 아니라 클러스터 상태에 대한 최신 정보를 유지할 수 있습니다.
...
SolidFire Active IQ에 대한 자세한 내용은 를 https://docs.netapp.com/us-en/solidfire-active-iq/index.html["SolidFire Active IQ 설명서"^]참조하십시오.
...
* https://mysupport.netapp.com/site/tools/tool-eula/5ddb829ebd393e00015179b2["NetApp 지원 사이트 및 GT, Active IQ용 도구"^]
