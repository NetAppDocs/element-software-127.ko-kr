...
여러 노드 시스템에 대한 스토리지 정보를 볼 수 있습니다. 이 할당된 경우 link:../concepts/concept_solidfire_concepts_data_protection.html#custom_pd["사용자 지정 보호 도메인"]특정 노드에 할당된 보호 도메인을 확인할 수 있습니다.
...
TIP: 스토리지 수를 보려면 NetApp HCC(하이브리드 클라우드 제어) 대시보드를 확인하십시오. 을 link:task-hcc-dashboard.html["HCC 대시보드를 사용하여 스토리지 리소스를 모니터링합니다"]참조하십시오.
