...
.단계
. NetApp 지원 사이트의 페이지에서 설치에 필요한 OVA 또는 ISO를 link:https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["Element 소프트웨어"^]다운로드합니다. 새 OVA에는 업데이트된 SSL 인증서가 포함되어 있습니다.
+
